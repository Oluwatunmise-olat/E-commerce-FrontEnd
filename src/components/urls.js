...
export const logoutUrl = "http://localhost:8000/gateway/logout";
export const registerUrl = "http://localhost:8000/gateway/register";
...
// search url
export const  searchUrl = "http://localhost:8000/search/?q=";